...
class LibMSEEDTestCase(unittest.TestCase):
    ...
    def test_read_using_Traces(self):
        ...
        """
        mseed=libmseed()
        f=open(os.path.join(self.path,'BW.BGLD..EHE.D.2008.001_first20lines.ASCII'),'r')
    ...
    def test_findgaps(self):
        """
        Tests the findgaps Method. The values are compared with the printgaplist
        method of the libmseed library and visually compared with the SeisGram2K
        viewer.
        """
        mseed = libmseed()
