...
for root, dirs, files in os.walk(input_base):
    ...
    for seedfile in filelist:
        print seedfile
        x1seedfile = 'output-1.1' + os.sep + seedfile + '.1.xml'
        x2seedfile = 'output-1.1' + os.sep + seedfile + '.2.xml'
        oseedfile = 'output-1.1' + os.sep + seedfile
        ...
        sp.parseXSEEDFile(x1seedfile, version='1.1')
        # generate SEED
        seed2 = sp.getSEED()
