...
output_base = 'data' + os.sep + 'RESP' + os.sep + 'orfeus'
...
for folder in iglob('data' + os.sep + 'orfeus' + os.sep + '*'):
    # Save folder.
    cur_folder = folder.split(os.sep)[-1]
    # Get the files.
    for file in iglob(folder + os.sep + '*'):
        cur_file = file.split(os.sep)[-1]
        # Create output directory if necessary.
        working_folder = output_base + os.sep + cur_folder + os.sep + cur_file
