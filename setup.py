...
ENTRY_POINTS = {
    ...
    'obspy.plugin.waveform.TSPAIR': [
        'is_format = obspy.io.ascii.core:_is_tspair',
        'read_format = obspy.io.ascii.core:_read_tspair',
        'write_format = obspy.io.ascii.core:_write_tspair',
    ],
    'obspy.plugin.waveform.SLIST': [
        'is_format = obspy.io.ascii.core:_is_slist',
        'read_format = obspy.io.ascii.core:_read_slist',
        'write_format = obspy.io.ascii.core:_write_slist',
    ],
    'obspy.plugin.waveform.PICKLE': [
        'is_format = obspy.core.stream:_is_pickle',
        'read_format = obspy.core.stream:_read_pickle',
        'write_format = obspy.core.stream:_write_pickle',
    ],
    'obspy.plugin.waveform.CSS': [
        'is_format = obspy.io.css.core:_is_css',
        'read_format = obspy.io.css.core:_read_css',
    ],
    'obspy.plugin.waveform.DATAMARK': [
        'is_format = obspy.io.datamark.core:_is_datamark',
        'read_format = obspy.io.datamark.core:_read_datamark',
    ],
    'obspy.plugin.waveform.KINEMETRICS_EVT': [
        'is_format = obspy.io.kinemetrics.core:is_evt',
        'read_format = obspy.io.kinemetrics.core:read_evt',
    ],
    'obspy.plugin.waveform.GSE1': [
        'is_format = obspy.io.gse2.core:_is_gse1',
        'read_format = obspy.io.gse2.core:_read_gse1',
    ],
    'obspy.plugin.waveform.GSE2': [
        'is_format = obspy.io.gse2.core:_is_gse2',
        'read_format = obspy.io.gse2.core:_read_gse2',
        'write_format = obspy.io.gse2.core:_write_gse2',
    ],
    'obspy.plugin.waveform.MSEED': [
        'is_format = obspy.io.mseed.core:_is_mseed',
        'read_format = obspy.io.mseed.core:_read_mseed',
        'write_format = obspy.io.mseed.core:_write_mseed',
    ],
    'obspy.plugin.waveform.PDAS': [
        'is_format = obspy.io.pdas.core:_is_pdas',
        'read_format = obspy.io.pdas.core:_read_pdas',
    ],
    'obspy.plugin.waveform.SAC': [
        'is_format = obspy.io.sac.core:_is_sac',
        'read_format = obspy.io.sac.core:_read_sac',
        'write_format = obspy.io.sac.core:_write_sac',
    ],
    'obspy.plugin.waveform.SACXY': [
        'is_format = obspy.io.sac.core:_is_sacXY',
        'read_format = obspy.io.sac.core:_read_sacXY',
        'write_format = obspy.io.sac.core:_write_sacXY',
    ],
    'obspy.plugin.waveform.SEG2': [
        'is_format = obspy.io.seg2.seg2:_is_seg2',
        'read_format = obspy.io.seg2.seg2:_read_seg2',
    ],
    'obspy.plugin.waveform.SEGY': [
        'is_format = obspy.io.segy.core:_is_segy',
        'read_format = obspy.io.segy.core:_read_segy',
        'write_format = obspy.io.segy.core:_write_segy',
    ],
    'obspy.plugin.waveform.SU': [
        'is_format = obspy.io.segy.core:_is_su',
        'read_format = obspy.io.segy.core:_read_su',
        'write_format = obspy.io.segy.core:_write_su',
    ],
    'obspy.plugin.waveform.SEISAN': [
        'is_format = obspy.io.seisan.core:_is_seisan',
        'read_format = obspy.io.seisan.core:_read_seisan',
    ],
    'obspy.plugin.waveform.Q': [
        'is_format = obspy.io.sh.core:_is_q',
        'read_format = obspy.io.sh.core:_read_q',
        'write_format = obspy.io.sh.core:_write_q',
    ],
    'obspy.plugin.waveform.SH_ASC': [
        'is_format = obspy.io.sh.core:_is_asc',
        'read_format = obspy.io.sh.core:_read_asc',
        'write_format = obspy.io.sh.core:_write_asc',
    ],
    'obspy.plugin.waveform.WAV': [
        'is_format = obspy.io.wav.core:_is_wav',
        'read_format = obspy.io.wav.core:_read_wav',
        'write_format = obspy.io.wav.core:_write_wav',
    ],
    'obspy.plugin.waveform.Y': [
        'is_format = obspy.io.y.core:_is_y',
        'read_format = obspy.io.y.core:_read_y',
    ],
    'obspy.plugin.waveform.AH': [
        'is_format = obspy.io.ah.core:_is_ah',
        'read_format = obspy.io.ah.core:_read_ah',
    ],
    'obspy.plugin.event': [
    ...
    'obspy.plugin.event.MCHEDR': [
        ...
        'read_format = obspy.io.pde.mchedr:_read_mchedr',
    ],
    'obspy.plugin.event.JSON': [
        'write_format = obspy.io.json.core:_write_json',
    ],
    'obspy.plugin.event.ZMAP': [
        'is_format = obspy.io.zmap.core:_is_zmap',
        'read_format = obspy.io.zmap.core:_read_zmap',
        'write_format = obspy.io.zmap.core:_write_zmap',
    ],
    ...
    'obspy.plugin.event.NLLOC_HYP': [
        ...
        'read_format = obspy.io.nlloc.core:read_nlloc_hyp',
        ],
    'obspy.plugin.event.NLLOC_OBS': [
        'write_format = obspy.io.nlloc.core:write_nlloc_obs',
        ],
    ...
    'obspy.plugin.inventory.STATIONXML': [
        'is_format = obspy.io.stationxml.core:_is_stationxml',
        'read_format = obspy.io.stationxml.core:_read_stationxml',
        'write_format = obspy.io.stationxml.core:_write_stationxml',
    ],
    'obspy.plugin.inventory.SACPZ': [
        'write_format = obspy.io.sac.sacpz:_write_sacpz',
    ],
    'obspy.plugin.inventory.CSS': [
        'write_format = obspy.io.css.station:_write_css',
    ],
