...
# Standard and thirdparty library imports.
import fnmatch
import lxml.etree
...
# ObsPyck imports.
from plotting_tools import MultiCursor
from util import *

class ObsPyck(object):
    """
    ObsPyck class that serves mainly as a glue for all other components.
    """
    def __init__(self, interface, client, streams, options):
        """
        Set the basics.
        """
        # Stores all the GUI elements for easy access.
        self.interface = interface
        # Store the other init variables.
        self.client = client
        ...
        (warn_msg, merge_msg, self.streams) = \
                merge_check_and_cleanup_streams(self.streams, options)
        ...
        (self.streams, dicts) = setup_dicts(self.streams)
        self.dicts = dicts
        self.eventMapColors = []
        ...
        # Shortcut to matplotlib figure.
        self.fig = self.interface.canvas.fig
        # Shortcut to canvas.
        self.canv = self.interface.canvas
