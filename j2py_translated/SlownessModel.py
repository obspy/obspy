#!/usr/bin/env python
""" generated source for module SlownessModel """
# 
...
#  * 
#  
class SlownessModel(Serializable):
    """ generated source for class SlownessModel """
    @overloaded
    def __init__(self, vMod, minDeltaP, maxDeltaP, maxDepthInterval, maxRangeInterval, maxInterpError, allowInnerCoreS, slownessTolerance):
        """ generated source for method __init__ """
        super(SlownessModel, self).__init__()
        self.vMod = vMod
    ...
    def __init___0(self, radiusOfEarth, vMod, criticalDepth, highSlownessLayerDepthsP, highSlownessLayerDepthsS, fluidLayerDepths, pLayers, sLayers, minDeltaP, maxDeltaP, maxDepthInterval, maxRangeInterval, maxInterpError, allowInnerCoreS, slownessTolerance):
...
SlownessModel.#      * and any changes will possibly corrupt the SlownessModel.
