...
from obspy.core.util.obspy_types import (ComplexWithUncertainties, CustomFloat,
                                         ...
                                         ObsPyException,
                                         ZeroSamplingRate)
from obspy.io.xseed import Parser, utils
...
class Response(ComparingObject):
    ...
    def from_resp(cls, resp, frequency=None, sr=None):
        ...
        # Stage 1 from sensor
        b53 = resp.blockettes[53][0]
        b58 = next((b for b in resp.blockettes[58]
                    if b.stage_sequence_number == 1), None)
        resp._get_abbreviation
        ...
        stage1 = PolesZerosResponseStage(
            ...
            input_units=lookup_unit(resp.abbreviations,
                                    b53.stage_signal_input_units),
            output_units=lookup_unit(resp.abbreviations,
        ...
        inv_response = cls(resource_id='Resource_ID',
