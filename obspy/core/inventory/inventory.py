...
def read_inventory(path_or_file_object=None, format=None):
    ...
    .. note::
        ...
        For handling additional information not covered by the StationXML standard and
        how to output it to StationXML see the :ref:`ObsPy Tutorial <stationxml-extra>`.
    """
