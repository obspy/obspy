...
class StreamTestCase(unittest.TestCase):
    ...
    def test_read_pickle(self):
        ...
        Example pickle was written using obspy 1.0.3
        """
        pickle_file = os.path.join(self.data_path, 'example.pickle')
        ...
        self.assertEqual(st[2].stats.endtime,
                         UTCDateTime('2009-08-24T00:20:04.130000Z'))
        np.testing.assert_array_equal(
            st[0].data[:10], [0, 6, 75, 262, 549, 943, 1442, 1785, 2147, 3029])
        np.testing.assert_array_equal(
            st[1].data[:10], [624, 1125, 1647, 2607, 3320, 4389, 5764, 7078,
                              8063, 9458])
        np.testing.assert_array_equal(
            st[2].data[:10], [-9573, -11576, -14450, -16754, -20348, -23220,
                              -28837, -30811, -36024, -40052])
        np.testing.assert_array_equal(
            st[0].data[-10:], [-283742, -305558, -302737, -317144, -310056,
                               -308462, -302752, -304243, -296202, -313968])
        np.testing.assert_array_equal(
            st[1].data[-10:], [90493, 105062, 100721, 98631, 100355, 106287,
                               115356, 117989, 97907, 113225])
        np.testing.assert_array_equal(
            st[2].data[-10:], [-144765, -149205, -123622, -139548, -137160,
                               -154283, -103584, -138578, -128339, -125707])
