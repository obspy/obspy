...
class FieldsTestCase(unittest.TestCase):
    ...
    def test_readDateTime(self):
        ...
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 98700))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,01:30:22.9876~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 987600))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,01:30:22.0005~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 500))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,01:30:22.0000~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 0))
        self.assertEquals(field.write(dt), orig)
    ...
    def test_readCompactDateTime(self):
        ...
        #3 - wrong syntax
        orig = '1992'
        self.assertRaises(Exception, field.read, BytesIO(orig))
        orig = '1992,'
        self.assertRaises(Exception, field.read, BytesIO(orig))
        orig = '1992~'
        self.assertRaises(Exception, field.read, BytesIO(orig))
        ...
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 1200))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,00:00:22~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 0, 0, 22, 0))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,00:30~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 0, 30, 0, 0))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358,01~'
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 0, 0, 0))
        self.assertEquals(field.write(dt), orig)
        #
        orig = '2008,358~'
        dt = field.read(BytesIO(orig))
        ...
        dt = field.read(BytesIO(orig))
        self.assertEquals(dt, UTCDateTime(2008, 12, 23, 1, 30, 22, 500000))
