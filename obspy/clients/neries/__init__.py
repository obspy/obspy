# -*- coding: utf-8 -*-
"""
obspy.clients.neries - NERIES Web service client for ObsPy
==========================================================
...
try:
    ...
    msg = ("To use obspy.clients.neries you need to install either 'suds' ("
           "works on Python 2.x) or 'suds-jurko' (works on Python 2.x and "
           "Python 3.x)")
