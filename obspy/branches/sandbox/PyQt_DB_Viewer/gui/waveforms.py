...
class PreviewPlot(QtGui.QGraphicsRectItem):
    ...
    def __init__(self, y_start, height, hmargin, width, title, stream, count,
        ...
        self.channel_id = QtGui.QGraphicsSimpleTextItem(self.title, parent = self)
        ...
        self.id_box = QtGui.QGraphicsRectItem(self.channel_id.boundingRect(), parent = self)
...
class Waveforms(QtGui.QGraphicsView):
    ...
    def resizeEvent(self, event):
        ...
        """
        super(Waveforms, self).resizeEvent(event)
        # The event sizes method also accounts for scroll bars and the like.
        size = event.size()
