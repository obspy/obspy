...
from getpaz import getStationPAZ
import copy
...
for file in mseed_files:
    ...
    for tr in stream:
        try:
            paz, sensitivity = getStationPAZ(tr.stats.network,tr.stats.station,
                                             tr.stats.starttime)
        except ValueError:
        ...
        while samp < tr.stats.npts:
            ...
            data /= (sensitivity / 1e9)  #V/nm/s correct for overall sensitivity
