...
class SonicTestCase(unittest.TestCase):
    ...
    def test_sonicBbfk(self):
        ...
        raw = """
9.65490401e-01 8.70780661e-13 1.84349488e+01 1.26491106e+00
9.59400535e-01 7.54453737e-13 1.84349488e+01 1.26491106e+00
9.59788144e-01 6.01638964e-13 1.84349488e+01 1.26491106e+00
9.64473665e-01 6.02637731e-13 1.84349488e+01 1.26491106e+00
9.54958439e-01 5.13858053e-13 1.84349488e+01 1.26491106e+00
9.53330994e-01 4.29547646e-13 1.84349488e+01 1.26491106e+00
        """
    ...
    def test_sonicBbfkPrew(self):
        ...
        raw = """
3.85422463e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
3.51870804e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
3.55861157e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
3.67066314e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
3.64870211e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
3.60413214e-05 0.00000000e+00 1.84349488e+01 1.26491106e+00
        """
        ref = np.loadtxt(StringIO(raw), dtype='f4')
        np.testing.assert_allclose(ref, out[:, 1:])
    ...
    def test_sonicBf(self):
        ...
        raw = """
9.67606719e-01 2.28960532e-05 1.84349488e+01 1.26491106e+00
9.69335057e-01 1.97564749e-05 1.84349488e+01 1.26491106e+00
9.46067852e-01 1.54123841e-05 1.84349488e+01 1.26491106e+00
9.41080449e-01 1.43546068e-05 1.84349488e+01 1.26491106e+00
9.67305409e-01 1.35210630e-05 1.84349488e+01 1.26491106e+00
9.39513631e-01 1.13792741e-05 1.84349488e+01 1.26491106e+00
        """
        ref = np.loadtxt(StringIO(raw), dtype='f4')
        np.testing.assert_allclose(ref, out[:, 1:])
    ...
    def test_sonicBfPrew(self):
        ...
        raw = """
1.40348207e-01 2.28960532e-05 1.84349488e+01 1.26491106e+00
1.30415347e-01 1.97564749e-05 1.84349488e+01 1.26491106e+00
1.28008783e-01 1.54123841e-05 1.84349488e+01 1.26491106e+00
1.25878335e-01 1.43546068e-05 1.84349488e+01 1.26491106e+00
1.39312546e-01 1.35210630e-05 1.84349488e+01 1.26491106e+00
1.32947973e-01 1.13792741e-05 1.84349488e+01 1.26491106e+00
        """
        ref = np.loadtxt(StringIO(raw), dtype='f4')
        np.testing.assert_allclose(ref, out[:, 1:])
    ...
    def test_sonicCapon(self):
        ...
        raw = """
1.17234469e+01 1.17234469e+01 1.35000000e+02 8.48528137e-01
2.40054037e+03 2.40054037e+03 -1.69380345e+02 1.62788206e+00
4.49490862e+00 4.49490862e+00 -1.53434949e+02 4.47213595e-01
4.10257370e+03 4.10257370e+03 0.00000000e+00 1.00000000e-01
7.03232341e+02 7.03232341e+02 4.19872125e+01 2.69072481e+00
9.76931058e+01 9.76931058e+01 -3.86598083e+01 2.56124969e+00
        """
        ref = np.loadtxt(StringIO(raw), dtype='f4')
    ...
    def test_sonicCaponPrew(self):
        ...
        raw = """
1.12733499e-01 0.00000000e+00 3.36900675e+01 7.21110255e-01
1.77112262e-02 0.00000000e+00 2.65650512e+01 2.23606798e-01
8.14214170e-02 0.00000000e+00 1.66992442e+01 1.04403065e+00
1.27112655e-02 0.00000000e+00 1.84349488e+01 1.58113883e+00
1.74286539e-02 0.00000000e+00 1.40362435e+01 8.24621125e-01
4.49519407e-02 0.00000000e+00 1.96538241e+01 1.48660687e+00
        """
        ref = np.loadtxt(StringIO(raw), dtype='f4')
        np.testing.assert_allclose(ref, out[:, 1:], rtol=1e-6)
