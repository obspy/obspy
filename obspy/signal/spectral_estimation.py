...
class PPSD(object):
    ...
    def __init__(self, stats, metadata, skip_on_gaps=True,
    ...
    def plot_spectrogram(self, cmap=obspy_sequential, clim=None, grid=True,
        ...
        :param axes: Reuse given axes for plotting.
        :type flip: bool
        :param flip: If True, plots time in Y-axis instead of default X.
        :type datelabels: bool
        :param datelabels: If False, hide date labels (default True), useful
            for subplots sharing the same date axis.
        :type ylabel: bool
        :param ylabel: If False, hide ylabel (default True), useful
            for subplots (only with `flip=False`).
        :type idlabel: bool
        ...
        cb = plt.colorbar(quadmesh, ax=ax, fraction=0.05, pad=0.01)
        ...
        if not flip:
            ...
            ax.set_xscale('log')
            ax.set_ylim(self.times_processed[0].matplotlib_date,
                        (self.times_processed[-1] + self.step).matplotlib_date)
            ax.invert_yaxis()
