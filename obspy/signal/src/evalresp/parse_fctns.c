...
/* parse_list:  parses the RESP file blockettes for list filters (in a Blockette [55] or [45]).
                ...
                checked as the file is parsed. As with parse_pz(), for this routine to work,
                the lines must contain evalresp-3.0 style prefixes */
/* Ilya Dricker ISTI 06/21/00. I modify this routine to accommodate the form of the parsed blockette
  ...
  for(i = 0; i < nstages; i++) {
    ...
    for(j = 0; j < nresps; j++) {
      ...
      case 60:
        ...
        break;
      default:
	/* code to ignore unexpected blockette/field lines might be useful here, but need 
