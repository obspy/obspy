...
autosummary_generate = ["obspy.wav.rst"]
...
from sphinx.ext.autosummary.generate import _simple_warn, _simple_info, \
    find_autosummary_in_files, ensuredir, import_by_name, get_documenter, \
    generate_autosummary_docs
# monkey patch for Sphinx-1.0.6-py2.7.egg/sphinx/ext/autosummary/generate.py
# -- Generating output ---------------------------------------------------------
def obspy_generate_autosummary_docs(sources, output_dir=None, suffix='.rst',
    ...
    for name, path, template_name in sorted(items):
        ...
        try:
            ...
            def get_members(obj, typ, include_public=[]):
                ...
                # 3 Lines monkey patch Moritz, do not include imported modules
                if typ in ['class', 'function']:
                    public = [x for x in public
                            if obj.__name__ == getattr(obj, x).__module__]
                return public, items
...
generate.generate_autosummary_docs = obspy_generate_autosummary_docs
