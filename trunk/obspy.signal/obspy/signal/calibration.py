...
def relcalstack(st1, st2, calib_file, window_len, OverlapFrac=0.5, smooth=0):
    ...
    :param st1: Stream object, (known) the trace.stats dict like class must contain
                    the parameters "sampling_rate", "npts" and "station"
    :param st2: Stream object, (unknown) the trace.stats dict like class must contain
                    the parameters "sampling_rate", "npts" and "station"
    ...
    implemented after relcalstack.c by J.Wasserman and M.Ohrnberger 
    """
    # check Konno-Ohmachi
    if smooth < 0:
        smooth = 0
