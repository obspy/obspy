...
class TauPTestCase(unittest.TestCase):
    ...
    def test_getTravelTimesAK135(self):
        ...
        for i in range(len(lines)):
            ...
            self.assertAlmostEquals(item['tt'], float(parts[1].strip()), 3)
            self.assertAlmostEquals(item['toang'], float(parts[2].strip()), 3)
            self.assertAlmostEquals(item['dtdd'], float(parts[3].strip()), 3)
            self.assertAlmostEquals(item['dtdh'], float(parts[4].strip()), 3)
            self.assertAlmostEquals(item['dddp'], float(parts[5].strip()), 3)
        #2
        ...
        for i in range(len(lines)):
            ...
            self.assertAlmostEquals(item['dtdd'], float(parts[3].strip()), 3)
            self.assertAlmostEquals(item['dtdh'], float(parts[4].strip()), 3)
            self.assertAlmostEquals(item['dddp'], float(parts[5].strip()), 2)
    ...
    def test_getTravelTimesIASP91(self):
        ...
        for i in range(len(lines)):
            ...
            self.assertEquals(item['phase_name'], parts[0].strip())
            self.assertAlmostEquals(item['tt'], float(parts[1].strip()), 3)
            self.assertAlmostEquals(item['toang'], float(parts[2].strip()), 2)
            self.assertAlmostEquals(item['dtdd'], float(parts[3].strip()), 3)
            self.assertAlmostEquals(item['dtdh'], float(parts[4].strip()), 3)
            self.assertAlmostEquals(item['dddp'], float(parts[5].strip()), 3)
        #2
