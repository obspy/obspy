...
#-*- coding: utf-8 -*-
"""
SEG-2 read support for ObsPy.

The obspy.seg2 package contains methods in order to read seismogram
package contains methods in order to read seismogram
files in the SEG-2 (rev. 1) file format.
...
KEYWORDS = ['ObsPy', 'seismology', 'seismogram', 'SEG-2']
