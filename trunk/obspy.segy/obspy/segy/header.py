...
TRACE_HEADER_FORMAT = [
    # [length, name, special_type]
    # Special type enforces a different format while unpacking using struct.
    [4, 'trace_sequence_number_within_line', False],
    [4, 'trace_sequence_number_within_segy_file', False],
    [4, 'original_field_record_number', False],
    [4, 'trace_number_within_the_original_field_record', False],
    [4, 'energy_source_point_number', False],
    [4, 'ensemble_number', False],
    [4, 'trace_number_within_the_ensemble', False],
    [2, 'trace_identification_code', False],
    [2, 'number_of_vertically_summed_traces_yielding_this_trace', False],
    ...
    False],
    [4, 'receiver_group_elevation', False],
    [4, 'surface_elevation_at_source', False],
    [4, 'source_depth_below_surface', False],
    [4, 'datum_elevation_at_receiver_group', False],
    [4, 'datum_elevation_at_source', False],
    [4, 'water_depth_at_source', False],
    [4, 'water_depth_at_group', False],
    [2, 'scalar_to_be_applied_to_all_elevations_and_depths', False],
    [2, 'scalar_to_be_applied_to_all_coordinates', False],
    [4, 'source_coordinate_x', False],
    [4, 'source_coordinate_y', False],
    [4, 'group_coordinate_x', False],
    [4, 'group_coordinate_y', False],
    [2, 'coordinate_units', False],
    [2, 'weathering_velocity', False],
    [2, 'subweathering_velocity', False],
    [2, 'uphole_time_at_source_in_ms', False],
    [2, 'uphole_time_at_group_in_ms', False],
    [2, 'source_static_correction_in_ms', False],
    [2, 'group_static_correction_in_ms', False],
    [2, 'total_static_applied_in_ms', False],
    [2, 'lag_time_A', False],
    [2, 'lag_time_B', False],
    [2, 'delay_recording_time', False],
    [2, 'mute_time_start_time_in_ms', False],
    [2, 'mute_time_end_time_in_ms', False],
    [2, 'number_of_samples_in_this_trace', 'H'],
    [2, 'sample_interval_in_ms_for_this_trace', 'H'],
    [2, 'gain_type_of_field_instruments', False],
    [2, 'instrument_gain_constant', False],
    [2, 'instrument_early_or_initial_gain', False],
    [2, 'correlated', False],
    [2, 'sweep_frequency_at_start', False],
    [2, 'sweep_frequency_at_end', False],
    [2, 'sweep_length_in_ms', False],
    [2, 'sweep_type', False],
    [2, 'sweep_trace_taper_length_at_start_in_ms', False],
    [2, 'sweep_trace_taper_length_at_end_in_ms', False],
    [2, 'taper_type', False],
    [2, 'alias_filter_frequency', False],
    [2, 'alias_filter_slope', False],
    [2, 'notch_filter_frequency', False],
    [2, 'notch_filter_slope', False],
    [2, 'low_cut_frequency', False],
    [2, 'high_cut_frequency', False],
    [2, 'low_cut_slope', False],
    [2, 'high_cut_slope', False],
    [2, 'year_data_recorded', False],
    [2, 'day_of_year', False],
    [2, 'hour_of_day', False],
    [2, 'minute_of_hour', False],
    [2, 'second_of_minute', False],
    [2, 'time_basis_code', False],
    [2, 'trace_weighting_factor', False],
    [2, 'geophone_group_number_of_roll_switch_position_one', False],
    [2, 'geophone_group_number_of_trace_number_one', False],
    [2, 'geophone_group_number_of_last_trace', False],
    [2, 'gap_size', False],
    [2, 'over_travel_associated_with_taper', False],
    [4, 'x_coordinate_of_ensemble_position_of_this_trace', False],
    [4, 'y_coordinate_of_ensemble_position_of_this_trace', False],
    [4, 'for_3d_poststack_data_this_field_is_for_in_line_number', False],
    [4, 'for_3d_poststack_data_this_field_is_for_cross_line_number', False],
    [4, 'shotpoint_number', False],
    [2, 'scalar_to_be_applied_to_the_shotpoint_number', False],
    [2, 'trace_value_measurement_unit', False],
    ...
    [4, 'transduction_constant_mantissa', False],
    [2, 'transduction_constant_exponent', False],
    [2, 'transduction_units', False],
    [2, 'device_trace_identifier', False],
    [2, 'scalar_to_be_applied_to_times', False],
    [2, 'source_type_orientation', False],
    ...
    [4, 'source_energy_direction_mantissa', False],
    [2, 'source_energy_direction_exponent', False],
    ...
    [4, 'source_measurement_mantissa', False],
    [2, 'source_measurement_exponent', False],
    [2, 'source_measurement_unit', False],
    [8, 'unassigned', False]
]
